	...
	factory: (require) => {
		...
		var AccountsController = class {
			...
			snapshot() {
				...
				if (snapshot.status !== "ready" || !snapshot.writable || snapshot.revision === void 0) throw new Error("Settings are not writable");
				return {
			...
			async commit(ops, revision) {
				if (!await this.form.mutate(ops, revision)) throw new Error("Settings write was not accepted");
			}
			add(id) {
		...
		function apply(ctx) {
			...
			ctx.effect(() => ctx.configForms.whileServed([NAMESPACE], () => ctx.slots.inject("plugins.row.config", () => ctx.slots.register({
				...
				key: ROW_KEY
			}, (props) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FirecrawlCard, {
				view: props.view,
				form,
				accounts,
				ctx
		...
		function FirecrawlCard({ view = "page", form, accounts: controller, ctx }) {
			const snapshot = (0, react.useSyncExternalStore)(form.subscribe.bind(form), form.getSnapshot.bind(form));
			...
			if (view === "summary") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "搜索账号与负载均衡" });
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("fieldset", {
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", { children: ["策略 ", /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
									...
									onChange: (event) => act(() => form.set("strategy", event.target.value).then((ok) => {
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", { children: ["结果数 ", /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
									...
									onBlur: (event) => {
										...
										if (Number.isInteger(value) && value > 0) act(() => form.set("limit", value).then((ok) => {
											if (!ok) throw new Error("refused");
										}));
									}
								})] }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", { children: ["冷却毫秒 ", /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
									...
									onBlur: (event) => {
										const value = Number(event.target.value);
										if (Number.isInteger(value) && value >= 0) act(() => form.set("cooldownMs", value).then((ok) => {
											if (!ok) throw new Error("refused");
										}));
									}
								})] })
